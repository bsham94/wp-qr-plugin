...
class QRPluginAPI
{
    ...
    //     }
    // }
    // public function redirect_to_main_url_for_user_profile_with_encryption() //-------------------------------------- Need to change from post meta to database query
    // {
    //     global $wpdb;
    //     global $wp;
    //     $home_url = home_url('/');
    ...
    // public function is_key_valid($key, $post_id) //-------------------------------------- Need to change from post meta to database query
    // {
